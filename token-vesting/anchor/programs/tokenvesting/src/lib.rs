...
pub mod tokenvesting {
    ...
    pub fn claim_tokens(ctx: Context<ClaimTokens>, _company_name: String) -> Result<()> {
        ...
        let vested_amount = if now >= employee_account.end_time {
            ...
            {
                Some(vested_amount) => vested_amount / total_vesting_time as u64,
                None => {
...
#[error_code]
pub enum ErrorCode {
    #[msg("The claim is not available yet")]
    ClaimNotAvailableYet,

    #[msg("The vesting period is invalid")]
    InvalidVestingPeriod,

    #[msg("The calculation overflowed")]
    CalculationOverflow,

    #[msg("There are no more tokens to claim")]
    NothingToClaim,
}
